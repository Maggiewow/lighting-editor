 ...
 * @公司: 广电信通
 * @作者: 赵婷婷
 * @Date: 2021-11-18 16:48:17
 * @LastEditors: 赵婷婷
 * @LastEditTime: 2021-11-19 14:31:59
 */
// 插件类，需要基于这个扩展
...
export default class Blockedit extends Plugin {
  init() {
    ...
    // 绑定一个事件 block
    this.editor.commands.add('introduction', new command(this.editor));
  }

  // 具体参数看文档： https://ckeditor.com/docs/ckeditor5/latest/api/module_engine_model_schema-Schema.html
  _defineSchema() {
    const schema = this.editor.model.schema;
    // 创建一个模型，名字是 introductionEdit
    schema.register('introductionEdit', {
    ...
    schema.register('introLabel', {
      isLimit: true,
      // 在哪个地方使用
      allowIn: 'introductionEdit',
      // 设置改节点是块还是根，根可以回车
  ...
  _defineConverters() {
    ...
    // 定义转换器  introductionEdit模型转换成视图  -> <div class="introductionEdit"></div>
    conversion.elementToElement({
      model: 'introductionEdit',
      view: {
        name: 'div',
        classes: 'labelLine',
      },
