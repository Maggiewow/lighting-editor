 ...
 * @LastEditors: 赵婷婷
 * @LastEditTime: 2021-11-19 15:07:52
 */
...
export default class BoxUI extends Plugin {
  init() {
    ...
    // 将显示在工具栏中。
    editor.ui.componentFactory.add('paralanguage', (locale) => {
      const view = editor.editing.view;
      const command = editor.commands.get('paralanguage');
      ...
      // 单击(执行)按钮时执行命令。
      this.listenTo(buttonView, 'execute', () => editor.execute('paralanguage'));
