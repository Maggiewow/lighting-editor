 ...
 * @LastEditors: 赵婷婷
 * @LastEditTime: 2021-11-19 14:48:53
 */
...
function createSimpleBox(writer) {
  const paralanguageEdit = writer.createElement('paralanguageEdit');
  const paraLabel = writer.createElement('paraLabel');
  writer.insertText('【同期声】', writer.createPositionAt(paraLabel, 0));
  writer.append(paraLabel, paralanguageEdit);

  return paralanguageEdit;
}
